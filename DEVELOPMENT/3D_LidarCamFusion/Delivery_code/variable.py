...
shared_memory_receive_from_cam = "CAM_TO_DELIVERY_PROCESS"
shared_memory_send_to_cam      = "DELIVERY_PROCESS_TO_CAM"
shared_memory_send_to_main     = "DELIVERY_PROCESS_TO_MAIN"

send_to_cam_mem_size         = 4 * 1
send_to_main_mem_size        = 4 * 1
