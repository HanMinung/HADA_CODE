...
path = "c:\HADA\source\HADA2\src\MORAI"
...
class planner :
    ...
    def main_loop(self):
        ...
        if len(status_data) != 0:
            # print('size : ', status_data.shape)
            print('status_data[1] : ', status_data[18])

        # velvel = status_data[18]
        ...
        send_velocity = command_velocity/10 # cmd_type이 2일때 원하는  속도를 넣어준다.
