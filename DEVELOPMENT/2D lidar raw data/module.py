...
class LiDAR_SHAREDMEM :
    ...
    def lidar_sharedmem_open(self) :
        ...
        self.msvcrt_dll                 = ct.cdll.msvcrt  
        ...
        self.rbyte_len = ct.sizeof(LIDAR_DATA)    
